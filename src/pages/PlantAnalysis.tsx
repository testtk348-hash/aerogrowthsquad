        ...
        <div className="flex-1 overflow-y-auto p-4">
          {result ? (
            ...
            <div className="space-y-6">
              <div className="relative">
                <img 
                  src={preview} 
                  alt="Preview" 
                  className="w-full h-80 object-cover rounded-2xl border-2 border-gray-200 shadow-sm" 
                />
                <Button
                  variant="secondary"
                  size="icon"
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base text-green-600">Tap analyze to get AI results</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              {/* Upload Zone */}
              <div
                className="border-3 border-dashed border-primary/40 rounded-2xl p-12 text-center cursor-pointer hover:border-primary/60 hover:bg-primary/5 transition-all duration-200 active:scale-[0.98]"
              ...
              >
                ...
                <p className="font-bold text-gray-900 text-xl mb-3">Upload Plant Image</p>
                <p className="text-lg text-gray-600 mb-4">Select from device storage</p>
                <p className="text-base text-gray-500">JPG, PNG, WebP • Max 8MB</p>
              </div>
